...
@section('contents')
    <div id="content">
        <div class="container">
            <form class="form content-padding" method="POST" action="{{ url('/task/update/' . $task->id) }}"
                ...
                <div class="card card-custom shadow pb-5 mt-10 rounded">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h2 class="card-label font-weight-bold">Edit Task
                            </h2>
                        </div>
                    </div>
                        ...
                        <div class="form-group row align-items-center mt-2">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="deadline" class="form-control" id="datepicker"
                                    placeholder="Select a date" required value="{{ $task->deadline }}">
                            </div>
                        </div>
                        <div class="form-group row align-items-center mt-2">
                            <div class="col-lg-3">
                        ...
                        <div class="form-group row align-items-center mt-2">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control" name="is_done" required>
                                    <option></option>
                                    <option value="0" {{ $task->is_done == 0 ? 'selected' : '' }}>On Progress</option>
